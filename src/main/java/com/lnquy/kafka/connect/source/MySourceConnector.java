...
public class MySourceConnector extends SourceConnector {
    ...
    public void start(Map<String, String> props) {
        // Do your initial setup for the whole source connector here
    }

    @Override
    public Class<? extends Task> taskClass() {
        return MySourceTask.class; // Return the actual task class for this connector
    }
    ...
    public ConfigDef config() {
        return MySourceConfig.conf(); // Parse custom config
    }
}
